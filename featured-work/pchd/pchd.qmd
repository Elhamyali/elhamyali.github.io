...
::: article-navigation
<a href="/featured-work/bridgehome/bridgehome.qmd" class="nav-arrow left-arrow">←</a> <!-- Left arrow for previous --> <a href="/featured-work/wsbh/wsbh.qmd" class="nav-arrow right-arrow">→</a> <!-- Right arrow for next -->
:::