...
::: article-navigation
<a href="/featured-work/healthcare-ready/index.qmd" class="nav-arrow left-arrow">←</a> <!-- Left arrow for previous --> <a href="/featured-work/pima-county-health-department/index.qmd" class="nav-arrow right-arrow">→</a> <!-- Right arrow for next -->
:::
