...
::: article-navigation
<a href="/featured-work/pchd/pchd.qmd" class="nav-arrow left-arrow">←</a> <!-- Left arrow for previous --> <a href="/featured-work/1-usdr/usdr.qmd" class="nav-arrow right-arrow">→</a> <!-- Right arrow for next -->
:::
