...
::: article-navigation
<a href="/featured-work/columbia-university/index.qmd" class="nav-arrow left-arrow">←</a> <!-- Left arrow for previous --> <a href="/featured-work/bridge-to-home/index.qmd" class="nav-arrow right-arrow">→</a> <!-- Right arrow for next -->
:::
