...
subtitle: "Help shape how U.S. cities build healthy, resilient, and equitable communities"
format: 
  html:
    page-layout: full
    toc: true
...
![](/images/johns-hopkins-study/parks2.jpg){fig-alt="Parks with a carved path that has trees surrounded around it"}
...
Across the United States, cities, counties, and townships are investing in parks and green spaces to improve community health, equity, and climate resilience. But what helps local governments make that happen and what gets in the way?
...
-   Get a **\$10 gift card** for completing the online survey and **\$50** for a virtual interview

We can send you gift cards digitally, by mail, or donate it to a charity of your choice.
...
Contact **Elham Ali** at [eali6\@jhu.edu](mailto:eali6@jhu.edu). Questions about participant rights? Contact the **Johns Hopkins BSPH IRB** at [bsph.irboffice\@jhu.edu](mailto:bsph.irboffice@jhu.edu) or 410-955-3193.
